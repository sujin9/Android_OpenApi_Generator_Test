...
//                "petstore_auth" -> OAuth(
//                    OAuthFlow.implicit,
//                    "https://petstore.swagger.io/api/oauth/dialog",
//                    "",
...
//    }
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "com.example.network.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://petstore.swagger.io/v2")
        }
    }
}
